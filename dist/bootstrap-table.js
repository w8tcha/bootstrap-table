(function (global, factory) {
  ...
  function getBootstrapVersion() {
    var _window$bootstrap, _globalThis$$;
    ...
    var jqDropdownVersion = (_globalThis$$ = globalThis.$) === null || _globalThis$$ === void 0 || (_globalThis$$ = _globalThis$$.fn) === null || _globalThis$$ === void 0 || (_globalThis$$ = _globalThis$$.dropdown) === null || _globalThis$$ === void 0 || (_globalThis$$ = _globalThis$$.Constructor) === null || _globalThis$$ === void 0 ? void 0 : _globalThis$$.VERSION;
  ...
  function getSearchInput(that) {
    ...
    var toolbarResult = DOMHelper.$(that.$toolbar);
    var toolbarEl = Array.isArray(toolbarResult) ? toolbarResult[0] : toolbarResult;
    if (!toolbarEl) {
      return null;
    }
    var matches = DOMHelper.find(toolbarEl, '.search input');
    return (_matches$ = matches[0]) !== null && _matches$ !== void 0 ? _matches$ : null;
  }
  ...
  var Constants = {
    ...
    METHODS: METHODS,
    THEME: "bootstrap".concat(bootstrapVersion || 5),
    VERSION: VERSION
  };
