    ...
    return _createClass(_default, [{
      ...
      value: function initPagination() {
        ...
        if (this.options.pagination && this.paginationParts.includes('pageSize')) {
          var toggle = this.$pagination.flatMap(function (p) {
            return _toConsumableArray(p.querySelectorAll('.dropdown-toggle'));
          })[0];
          var content = this.$pagination.flatMap(function (p) {
            return _toConsumableArray(p.querySelectorAll('.dropdown-content'));
          })[0];
          if (toggle && content !== null && content !== void 0 && content.id) {
